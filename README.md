# qchem
A framework for molecular modeling.  This framework combines the most powerful open-source libaries for machine learning, geometric deep learning, and chemoinformatics with full featured molecular datasets while remaining light weight, modular and extendable.  
...
* pytorch=2.2.2, pyg=2.5.2, cuda=12.1, python=3.12.2, rdkit=2024.03.1, scikit-learn=1.4, torcheval=0.0.7
